...
import android.widget.Toast;
	...
	public class ListAlbumActivity extends ExpandableListActivity {
	...
	private List<ArrayList<HashMap<String, String>>> createChildList() {
 		...
 		Cursor musiccursor = managedQuery(MediaStore.Audio.Media.EXTERNAL_CONTENT_URI,proj, null, null, MediaStore.Audio.Media.ALBUM);
 		...
 		{					
			...
			String groupepalbum = musiccursor.getString(musiccursor.getColumnIndexOrThrow(MediaStore.Audio.Media.ALBUM));
	...
	private List<HashMap<String, String>> createGroupList() {
		...
		String where = "1=1) GROUP BY (ALBUM";
		Cursor musiccursor = managedQuery(MediaStore.Audio.Media.EXTERNAL_CONTENT_URI,proj, where, null,MediaStore.Audio.Media.ALBUM);
		int count = musiccursor.getCount();
		for(int i=0; i<count; i++)
		{
			musiccursor.moveToPosition(i);
    ...
    public boolean onChildClick( ExpandableListView parent, View v, int groupPosition,int childPosition,long id) 
    {
    	String[] proj = { MediaStore.Audio.Media._ID,
			...
			Cursor musiccursor = managedQuery(MediaStore.Audio.Media.EXTERNAL_CONTENT_URI,proj, MediaStore.Audio.Media.ALBUM + " like ? ", new String[] {myAlbum}, MediaStore.Audio.Media.ALBUM);
			int count = musiccursor.getCount();
